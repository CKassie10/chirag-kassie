export const profile = {
  ...
  tagline: "Shipping live, production websites for real clients.",
  location: "Tongaat, Durban — open to relocation",
  email: "kassiechirag10@gmail.com",
  phone: "+27 62 482 2900",
  ...
  about: [
    ...
    "Alongside software, I have hands-on IT infrastructure experience (Windows Server, Active Directory, networking, cloud services) from my time supporting UKZN's campus systems. I'm motivated by engineering excellence, continuous learning, and client-focused delivery.",
  ],
} as const;
